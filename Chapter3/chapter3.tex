...
obtain a marginal probability by summing over all possible hidden states $i \in I$, as per \cite{Jurafsky2008}.
...
and allows us to avoid numerical underflow, as in \ref{eq:loglike}, where summation is nested inside the logarithm, and therefore we cannot simply swap the order of summation and logarithm. Therefore, we need to find a way to compute the log-likelihood function 
