...
\begin{figure}[htbp]
    ...
    \end{subfigure}
\caption[Visualization of posteriori variables resulting from E-step]{Trellis describing (a) $\gamma_t(i)$ variable as a product of $\alpha_t(i)$ and $\beta_t(i)$ variables and 
...
\section{Application to AR(p) HMM model}
